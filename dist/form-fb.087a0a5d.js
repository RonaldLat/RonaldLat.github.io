...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"form-fb.js":[function(require,module,exports) {
var firebaseConfig = {
...
firebase.analytics(); //form handling
...
submitBtn.addEventListener('click', submitForm); // document.querySelector('form').addEventListener('submit', submitForm)
//submit form
...
function submitForm(e) {
  ...
  var email = getInputVal('#email'); // let phone = getInputVal('#phone')
...
function saveMessage(name, email, time, message) {
  ...
  newMessageRef.set({
    ...
    document.querySelector('form').reset(); // verification.style.transform = 'translateX(0)'
    // setTimeout(() => {
...
},{}]},{},["../../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","form-fb.js"], null)
//# sourceMappingURL=/form-fb.087a0a5d.js.map