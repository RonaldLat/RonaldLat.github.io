...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"form-engine.js":[function(require,module,exports) {
  ...
  arrows.forEach(function (arrow) {
    arrow.addEventListener('click', function () {
      ...
      if (input.type === 'text' && validateUser(input)) {
        ...
        nextField(parent, nextForm);
      } else if (input.type === 'submit') {// nextField(parent, nextForm)
...
function error(color, e) {
  var parent = e.parentElement; // gsap.to('', {
  //     duration: 0.5,
  //     backgroundColor: 'navy'
  // });
...
animatedForm();
document.querySelector('.field-email input').addEventListener('keypress', function (e) {
  if (e.key == 'Enter') {
    e.preventDefault();
  }
});
...
},{}]},{},["../../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","form-engine.js"], null)
//# sourceMappingURL=/form-engine.cf8b254d.js.map