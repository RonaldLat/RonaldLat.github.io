...
function toggleNav() {
  ...
  var homeSect = document.querySelector(".home");
...
function pageIndicator() {
  ...
  var icons = document.querySelectorAll(".nav-icons a ");
  var sections = document.querySelectorAll("section");
  var observer = new IntersectionObserver(function (entries, observer) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        var section = entry.target.getAttribute("id");
        var navActive = document.querySelector("a[href=\"#".concat(section, "\"]"));
        icons.forEach(function (icon) {
          return icon.classList.remove('page-active');
        });
  ...
  var observer = new IntersectionObserver(function (entries, observer) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        ...
        entry.target.style.opacity = '100%'; // left.style.transform='translate(0)'
...
function skillIn() {
  var element = document.querySelectorAll('.up-animation');
  var options = {
    threshold: 0.3
  };
  var observer = new IntersectionObserver(function (entries, observer) {
  ...
  }, options); // observer.observe(skill);
...
var diamondPath = document.querySelectorAll('#diamondPath'); // pwa and service workers
